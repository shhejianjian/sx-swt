...
#import "SWTBase.h"
@interface SWTGSSecondViewController ()
@property (strong, nonatomic) IBOutlet UIWebView *myWebView;

@end

@implementation SWTGSSecondViewController
...
- (void)loadWebView {
    NSString *fyJJIDStr = [[NSUserDefaults standardUserDefaults]objectForKey:@"selectSpwyID"];
