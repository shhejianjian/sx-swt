...
@interface SWTAddXsViewController () <UITextViewDelegate,LDActionSheetDelegate,LDImagePickerDelegate>
...
@implementation SWTAddXsViewController
...
- (IBAction)uploadFile:(id)sender {
    ...
    if (self.showImg.image) {
        ...
        params[@"content"] = self.contentTextField.text;
        params[@"jbxsid"] = self.jbxsIdStr;
        
        NSError *playerError = nil;
        AFHTTPRequestSerializer *serializer = [AFHTTPRequestSerializer serializer];
        NSMutableURLRequest *request =
        [serializer multipartFormRequestWithMethod:@"POST"//请求方法为post
                                         URLString:UpLoadXsFjUrl//上传文件URL
...
//        [manager POST:UpLoadXsFjUrl parameters:params constructingBodyWithBlock:^(id<AFMultipartFormData> formData) {
