...
- (void)changeItem:(UIButton *)sender {
    ...
    if (!_btncollectionView) {
        ...
        _btncollectionView = [[BtnCollectionView alloc] initWithFrame:CGRectMake(0, -([self theResponeController].view.bounds.size.height-114), self.bounds.size.width, [self theResponeController].view.bounds.size.height-64) collectionViewLayout:layout];
