...
@interface SWTFirstChooseMapVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SWTFirstChooseMapVC

- (void)viewDidLoad {
    [super viewDidLoad];
    NSString *checkCourtName = [[NSUserDefaults standardUserDefaults]objectForKey:@"selectCourtName"];
